...
//funções ulteis
    ...
    public void detalhes(){
        ...
        System.out.println("com: "+this.numerodepaginas+" paginas.");
        System.out.println("do genero: "+this.tiposdelivros.name()+".");
        System.out.println("com: "+this.numerodeexemplares+" exemplares no estoque");
        System.out.println("No valor de "+this.preco+" R$");
    }  
